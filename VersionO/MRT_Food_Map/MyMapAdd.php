		...
		<div id="page-wrapper">
			...
			<section id="header">
				<div class="container">
					...
					<header>
						<h1><strong>MyMap</strong></h1>
                        <h2><strong>來添加自己的私房餐廳吧！</strong></h2>
					</header>
					<br>
					<div class=container>
						<form name="recommend" method="post" action="MyMapAddTo.php">
							<section>
								<p>餐廳名稱</p>
							...
							<section>
								...
								<div class="col-6 col-12-small">
									<center> <!--php-->
										<select id="college-list" onchange="changeCollege(this.selectedIndex)" style="width:350px;">
                                        </select>
										<br>
									<p>選擇捷運站</p>
